                ...
                <g>
                    <g>
                        <rect
                            ...
                            style="fill: #FFFFFF"
                        />
                        <text :x="halfSize - 570" :y="topHeight - 30">
                            <tspan font-size="14px" font-weight="bold">
                                {{ name }}
                            </tspan>
                        </text>

                        <text :x="halfSize - 585" :y="topHeight + 5">
                            <tspan font-size="12px">
                                {{ project }}
                            </tspan>
                        </text>
                        <text :x="halfSize - 330" :y="topHeight - 30">
                            <tspan font-size="14px" font-weight="bold">
                                {{
                                    statusPublished
                                        ? 'Published'
                        ...
                        <g>
                            <image
                                ...
                                :y="topHeight + 22"
                                width="30"
                                xlink:href="https://img.icons8.com/fluency-systems-filled/48/000000/json.png"
                            />
                        </g>
                        <image
                            id="show-growth"
                            ...
                            width="30"
                            @click="showCharts"
                            xlink:href="https://img.icons8.com/external-vitaliy-gorbachev-lineal-color-vitaly-gorbachev/60/000000/external-growth-infographic-elements-vitaliy-gorbachev-lineal-color-vitaly-gorbachev-1.png"
                        />
                        <text :x="halfSize - 320" :y="topHeight + 6">
                            <tspan font-size="12px">
                                {{ lastSeen }}
                            </tspan>
                        </text>
                        <path
                            class="line"
                            d="M400,200 C500, 200 220,200 310,200"
                        ></path>
                    </g>
                </g>
                <g v-if="statusPublished">
