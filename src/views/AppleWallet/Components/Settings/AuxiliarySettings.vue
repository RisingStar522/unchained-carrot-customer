<template>
    <div class="content">
            ...
            <b-col sm="6">
                <b-row class="mb-4">
                    <b-col
                        ...
                        sm="12"
                    >
                        <h4 class="text-brand">Auxiliary Fields</h4>
                        <div>
                ...
                <b-row class="my-4">
                    <b-col sm="12">
                        <p>
                            The Auxiliary Fields can contain 4 horizontal
        ...
        <RecommendFieldsModal @confirm="addAuxiliaryFields" />
