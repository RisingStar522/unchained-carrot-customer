<template>
    <div class="content">
            ...
            <b-col sm="6">
                <b-row class="mb-4">
                    <b-col
                        ...
                        sm="12"
                    >
                        <h4 class="text-brand">Secondary Fields</h4>
                        <div>
                ...
                <b-row class="my-4">
                    <b-col sm="12">
                        <p>
                            The Secondary Fields can contain 4 horizontal
                            fields. Each field can be configured to display
                            text, url, email, phone number, number, date or
                ...
                <b-row class="my-4">
                    <b-col sm="12" class="accordion">
                        <b-card no-body class="mb-2" v-for="(field, i) in fields" :key="i">
                            <b-button
                                block
                ...
                <b-row class="my-4">
                    <b-col class="d-flex justify-content-end" sm="12">
                        <b-button variant="brand" @click="openFieldsModal">Add field</b-button>
                    </b-col>
                </b-row>
            </b-col>
            <b-col sm="6">
        ...
        <RecommendFieldsModal @confirm="addSecondaryFields" />
